package com.gndps.kolshopmaterial.adapters;
...
import com.gndps.kolshopmaterial.model.Product;
import com.gndps.kolshopmaterial.viewholders.ProductItemViewHolder;
...
public class ProductListAdapter extends RecyclerView.Adapter<ProductItemViewHolder> {
    ...
    public ProductItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = inflator.inflate(R.layout.product_list_item, viewGroup, false);
