...
import com.koleshop.appkoleshop.model.ShopSettings;
...
public class LocationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.koleshop.appkoleshop.R.layout.activity_location);
        setUpLocationName();
        setUpMapIfNeeded();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.koleshop.appkoleshop.R.menu.location, menu);
        return true;
    }
    ...
    private void setUpMapIfNeeded() {
        if (googleMap == null) {
            googleMap = ((MapFragment) getFragmentManager().findFragmentById(com.koleshop.appkoleshop.R.id.map))
                    .getMap();
            if (googleMap != null) {
