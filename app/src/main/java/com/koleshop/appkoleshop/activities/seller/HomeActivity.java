package com.koleshop.appkoleshop.activities.seller;
...
import com.koleshop.appkoleshop.activities.settings.SellerSettingsActivity;
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.drawer_settings:
                        //Settings
                        drawerLayout.closeDrawers();
                        Intent intent3 = new Intent(mContext, SellerSettingsActivity.class);
