...
public class VerifyOTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.koleshop.appkoleshop.R.layout.activity_verify_otp);
        mContext = this;
        ...
        progressBar = (ProgressBar) findViewById(com.koleshop.appkoleshop.R.id.progressBarOtp);
        textInputLayout = (TextInputLayout) findViewById(com.koleshop.appkoleshop.R.id.input_layout_verification_code);
