...
package com.koleshop.api.productEndpoint;
...
public class ProductEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the productEndpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetProductsList extends ProductEndpointRequest<com.koleshop.api.productEndpoint.model.ProductCollection> {
    ...
    protected GetProductsList(java.lang.Integer shopId, java.lang.Integer startIndex, java.lang.Integer count) {
      super(ProductEndpoint.this, "GET", REST_PATH, null, com.koleshop.api.productEndpoint.model.ProductCollection.class);
   ...
   * operation.
   *
   * @param content the {@link com.koleshop.api.productEndpoint.model.Product}
   * @return the request
   */
  public SaveProduct saveProduct(com.koleshop.api.productEndpoint.model.Product content) throws java.io.IOException {
    SaveProduct result = new SaveProduct(content);
    initialize(result);
    return result;
  }

  public class SaveProduct extends ProductEndpointRequest<com.koleshop.api.productEndpoint.model.RestCallResponse> {
     ...
     * @since 1.13
     */
    protected SaveProduct(com.koleshop.api.productEndpoint.model.Product content) {
      super(ProductEndpoint.this, "POST", REST_PATH, content, com.koleshop.api.productEndpoint.model.RestCallResponse.class);
    }
