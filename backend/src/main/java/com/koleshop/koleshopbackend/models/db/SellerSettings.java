...
public class SellerSettings {
    ...
    public SellerSettings(Long id, Long userId, String imageUrl, String headerImageUrl, Address address, int shopOpenTime, int shopCloseTime, boolean pickupFromShop, boolean homeDelivery, Long maximumDeliveryDistance, Float minimumOrder, Float deliveryCharges, Float carryBagCharges, int deliveryStartTime, int deliveryEndTime, boolean shopOpen) {
        this.id = id;
        this.userId = userId;
