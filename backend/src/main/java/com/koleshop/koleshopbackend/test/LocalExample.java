package com.koleshop.koleshopbackend.test;
...
public class LocalExample {
    ...
    private static final Logger logger = Logger.getLogger(LocalExample.class.getName());
    ...
    public void runTest() throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            GcsFilename filename = new GcsFilename("koleshop-bucket", "foo");
            Map<String, String> mapContent = new HashMap<>();
            mapContent.put("foo", "bar");

            writeObjectToFile(filename, mapContent);

            logger.log(Level.INFO, "Wrote " + mapContent + " read: " + readObjectFromFile(filename));
            ...
            logger.log(Level.INFO, "Wrote " + Arrays.toString(byteContent) + " read: "
